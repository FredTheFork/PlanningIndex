...
export const intakeFormSections: FormSection[] = [
  ...
  // ── SECTION 4 — PRICING, PAYMENT & PROTECTION ──
  {
    ...
    fields: [
      { id: 'q25_pricing_model', questionNumber: 'Q25', label: 'How do you charge for your services?', type: 'multi_select', required: true, options: ['Fixed project fee', 'Hourly rate', 'Monthly retainer', 'Day rate', 'Milestone / stage payments', 'Subscription', 'Other'] },
      ...
      { id: 'q30_payment_methods', questionNumber: 'Q30', label: 'What payment methods do you accept?', type: 'multi_select', required: true, options: ['Bank transfer (BACS)', 'PayPal', 'Stripe', 'GoCardless', 'Wise', 'Cash', 'Card reader', 'Other'] },
  ...
  // ── SECTION 5 — GDPR & DATA PROTECTION ──
  {
    ...
    fields: [
      ...
      { id: 'q48_tracking_tools', questionNumber: 'Q48', label: 'Which tracking tools do you use?', type: 'multi_select', required: false, options: ['Google Analytics', 'Meta (Facebook) Pixel', 'TikTok Pixel', 'Hotjar or Microsoft Clarity', 'Cookie consent banner tool', 'Other'], conditionalOn: { field: 'q47_uses_cookies', value: 'Yes' } },
    ],
  },
  ...
  // ── SECTION 10 — FINAL CONFIRMATION ──
  {
    ...
    fields: [
      ...
      { id: 'q79_how_heard', questionNumber: 'Q79', label: 'How did you hear about Foundationary?', type: 'single_choice', required: false, options: ['LinkedIn', 'Instagram', 'TikTok', 'Facebook group', 'Referral from someone I know', 'Google search', 'Accountant or bookkeeper recommendation', 'Other'] },
...
export const upsellFormSections: FormSection[] = [
  ...
  },
  {
    ...
    fields: [
      { id: 'sm1_platforms', questionNumber: 'SM1', label: 'Which platforms are you focusing on right now?', type: 'multi_select', required: true, options: ['LinkedIn', 'Instagram', 'TikTok', 'Facebook', 'X (Twitter)', 'Pinterest', 'Other'] },
