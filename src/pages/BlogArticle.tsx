      ...
      <div className="min-h-screen flex items-center justify-center bg-[#FAFBFC]">
        <div className="text-center px-6">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-12 max-w-md">
            ...
            <p className="text-gray-600 mb-6">Sorry, we couldn't find that article. It may have been moved or deleted.</p>
            <Link to="/blog" className="inline-flex items-center gap-2 text-[#2C68C4] hover:text-[#1B3F7A] font-semibold transition-colors">
              <ArrowLeft size={18} />
              Back to Blog
            </Link>
          </div>
      ...
      <div className="min-h-screen bg-[#FAFBFC]">
        ...
        <article className="max-w-[840px] mx-auto px-6 py-12 md:py-16">
          ...
          {relatedArticles.length > 0 && (
            <div className="mt-16">
              <h3 className="font-bold text-gray-900 text-2xl mb-8">Related Articles</h3>
                ...
                {relatedArticles.map((related) => (
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <h4 className="font-semibold text-gray-900 text-base mb-2 group-hover:text-[#2C68C4] transition-colors">
                        {related.title}
                      </h4>
