  ...
  return (
    <div>
      ...
      <textarea
        ...
        rows={4}
        className={`w-full rounded-md border px-3 py-2 font-inter text-sm text-[#1A1A2E] placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#2C68C4]/40 focus:border-[#2C68C4] transition-colors resize-y ${
