...
async function generateDocx(
  ...
  children.push(new Paragraph({
    children: [new TextRun({ text: 'This document was created for guidance and should be reviewed by a qualified professional before use.', italics: true, size: 16, font: 'Calibri', color: '888888' })],
    alignment: AlignmentType.CENTER,
  }));
...
<div class="footer">
  ...
  This document was created for guidance and should be reviewed by a qualified professional before use.
</div>
</body>
</html>`;
}
