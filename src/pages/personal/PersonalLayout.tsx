...
import { LayoutDashboard, FileText, BarChart3, FolderOpen, LogOut } from 'lucide-react';
      ...
      <div className="bg-white border-b border-border">
        <div className="max-w-[1200px] mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="font-inter text-secondary-text text-sm hidden sm:inline">Client Area</span>
          </div>
