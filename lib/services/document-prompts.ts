...
`,
  ...
  // Website Copy Pack
  {
    ...
    generationPrompt: `You are an expert website copywriter specialising in conversion-focused homepage content for UK small businesses and sole traders.

Create website homepage copy that converts visitors into enquiries.

────────────────────────
OBJECTIVE
────────────────────────

Create homepage copy that:
• Captures attention immediately
• Communicates value clearly
• Builds trust and credibility
• Drives action (enquiries, calls, sign-ups)
• Reflects the client's unique brand voice
...
{
  "hero": {
    "headline": "10 words max, result-focused, compelling",
    "subheadline": "1-2 sentences expanding on the promise",
    "ctaText": "5 words max, action-oriented button text"
  },
  "benefits": [
    {"title": "6 words max", "description": "2-3 sentences", "icon": "emoji or number"},
    {"title": "6 words max", "description": "2-3 sentences", "icon": "emoji or number"},
    {"title": "6 words max", "description": "2-3 sentences", "icon": "emoji or number"}
  ],
  "socialProof": {
    ...
    "testimonial": {
      "quote": "Authentic-sounding testimonial quote, 20-40 words",
      "author": "Client first name",
      "role": "Client role or business type"
    }
  },
  "finalCta": {
    "headline": "Urgency-focused headline",
    "body": "1-2 sentences reinforcing the next step",
...
• Match the client's brand voice from their brief
• Be specific to their industry and services
• Avoid generic phrases like "quality service" or "exceeding expectations"
• Focus on outcomes and results for the customer
• Use clear, simple language — no jargon
• Include industry-specific language where it adds credibility

────────────────────────
BRAND ALIGNMENT
────────────────────────

Review the client brief to identify:
• Brand personality (professional, friendly, premium, approachable)
• Target audience
• Key differentiators
• Tone of voice

Write in a voice that sounds authentic to this specific business.
`,
    agentInstructions: SHARED_AGENT_INSTRUCTIONS,
  },
  {
    ...
    generationPrompt: `You are an expert brand storyteller creating About page content for UK small businesses.

Create an About page that builds connection, trust, and authority.

────────────────────────
OBJECTIVE
────────────────────────

Create about page copy that:
• Tells an authentic business story
• Builds emotional connection with visitors
• Demonstrates credibility and expertise
• Shows the human side of the business
• Reinforces why visitors should choose this business
...
Return a JSON object with this exact structure:
{
  "opening": "Belief/observation hook, 2-3 sentences that connect with the reader",
  "story": "Founder/business origin narrative, 150-250 words, written in first or third person appropriately",
  "values": [
    {"title": "Value name", "description": "What this means in practice, 2-3 sentences"},
    {"title": "Value name", "description": "What this means in practice, 2-3 sentences"},
    {"title": "Value name", "description": "What this means in practice, 2-3 sentences"}
  ],
  "whyWorkWithUs": [
    {"reason": "Why choose this business", "outcome": "The result clients can expect"},
    {"reason": "Another reason", "outcome": "Another result"},
    {"reason": "Third reason", "outcome": "Third result"}
  ],
  "teamSection": {
    "enabled": false
  },
  "cta": "Invitation to take the next step, 1-2 sentences"
}
...
If the brief includes personal background:
• Weave it into a compelling narrative
• Show the journey to this business
• Include motivations and values

If the brief lacks personal details:
• Focus on the business philosophy
• Emphasise the approach to serving clients
• Highlight what drives the quality of work

────────────────────────
WRITING STYLE
────────────────────────

• Authentic and genuine — never manufactured
• Match the client's established voice
...
`,
  ...
  },
  {
    ...
    generationPrompt: `You are an expert service page copywriter creating compelling service descriptions for UK small businesses.

Create service pages that drive enquiries by clearly articulating value.

────────────────────────
OBJECTIVE
────────────────────────

Create service page copy that:
• Clearly explains what the service includes
• Builds confidence in the service quality
...
Return a JSON object with this exact structure:
{
  "intro": "2-3 outcome-focused sentences introducing the services",
  "services": [
    {
      "name": "Service name",
      "description": "What this service delivers, 2-4 sentences",
      "included": ["Item one", "Item two", "Item three", "Item four"],
      "notIncluded": ["Excluded item (if relevant)"],
      "outcome": "The result or benefit clients receive",
      "investment": "Price indication if available, or 'Contact for pricing'"
    }
  ],
  "cta": {
    "text": "Prompt to take the next step",
    "action": "Button text for the call-to-action"
  }
}
...
• Base services on brief information exactly
• Create one service block per distinct service identified
• Include specific deliverables where mentioned
• Be honest about inclusions — avoid overpromising
• Match any pricing mentioned in the brief

If no pricing is mentioned:
• Use "Contact for pricing" or similar
...
• Address implied objections through copy
• Use social proof subtly where appropriate
• Create urgency through scarcity if relevant
...
• Match the client's established brand voice
...
`,
  ...
  },
  {
    ...
    generationPrompt: `You are an expert copywriter creating contact page content for UK small businesses.

Create a contact page that makes it easy and appealing to get in touch.

────────────────────────
OBJECTIVE
────────────────────────

Create contact page copy that:
• Provides clear contact information
• Sets expectations for response times
• Encourages enquiries
• Removes friction from the contact process
• Builds confidence in reaching out
...
Return a JSON object with this exact structure:
{
  "heading": "Friendly, welcoming headline",
  "welcomeText": "2-3 warm sentences about what happens when they contact you",
  "howToReach": {
    "preferredMethod": "How they prefer to be contacted",
    "email": "Business email if available",
    "phone": "Phone number if available",
    "businessHours": "Response time or availability"
  },
  "whatHappensNext": "2-3 sentences explaining the process after they make contact",
  "socialLinks": {
    "linkedin": "URL or omit if not provided",
    "instagram": "URL or omit",
    "facebook": "URL or omit",
    "x": "URL or omit"
  }
}
...
• Use contact details from the brief exactly
• If specific details aren't provided, leave those fields empty
• Be realistic about response times (typically 24-48 hours)
• Match the client's established communication style
...
• Remove any anxiety about making contact
...
`,
  ...
  // Social Media Pack
  {
    ...
    generationPrompt: `You are a social media content strategist creating 30 engaging posts for UK small businesses.

Create a complete 6-week social media content calendar.

────────────────────────
OBJECTIVE
────────────────────────

Create 30 posts that:
  ...
  "posts": [
    {
      ...
      "week": 1,
      "day": "Mon",
      "caption": "Full post text ready to copy-paste, no hashtags in caption",
      "imagePrompt": "1-2 sentence description of what accompanying image should show"
    }
  ]
}

Repeat for all 30 posts.

Categories: educational, promotional, personal
...
Week 1-2: Focus on credibility and expertise
Week 3-4: Mix of educational and personal content
Week 5-6: Promotional with value-led content
...
LinkedIn: 200-300 words, professional tone, insight-driven
Instagram: 100-150 words, visual focus, engaging
...
• Match the client's brand voice from the brief
• Be authentic and specific to their industry
• Include actionable insights in educational posts
• Show genuine personality in personal posts
• Be promotional without being pushy
• Avoid generic inspirational quotes
• Avoid Steven Bartlett-style LinkedIn content
• No hashtags in captions (will be added separately)
...
Every post should feel like it genuinely comes from this specific business.
`,
    agentInstructions: SHARED_AGENT_INSTRUCTIONS,
  },
];
