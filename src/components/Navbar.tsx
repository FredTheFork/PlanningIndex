    ...
    >
      <div className="max-w-full mx-0 px-6 h-full flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-3 shrink-0" style={{ height: 40 }}>
          <img src="/Firefly_please_take_this_image,_upscale_it_and_make_the_background_fully_#ffffff,_centering_t_557602.png" alt="Foundationary" style={{ height: 40, width: 'auto' }} />
