...
const GEMINI_API_KEY = Deno.env.get("TEST_CLIENT_GEMINI_API_KEY") || Deno.env.get("GEMINI_API_KEY") || "";
...
// IMPORTANT: Field IDs, options, and conditional logic MUST exactly match
// lib/forms/intake-definition.ts. If that file changes, update this array too.
const ALL_SECTIONS: SectionDef[] = [
  {
    ...
    fields: [
      ...
      { id: "q2_business_name", type: "short_text", required: true },
      { id: "q3_business_registered", type: "single_choice", required: true, options: ["Sole trader", "Limited company", "Partnership / LLP", "Not registered yet"] },
      { id: "q4_companies_house", type: "short_text", required: false, conditionalOn: { field: "q3_business_registered", value: "Limited company" } },
      { id: "q5_jurisdiction", type: "single_choice", required: true, options: ["England & Wales", "Scotland", "Northern Ireland"] },
      { id: "q6_business_address", type: "long_text", required: true },
      { id: "q7_document_email", type: "email", required: true },
      { id: "q8_business_phone", type: "phone", required: false },
      { id: "q9_has_website", type: "single_choice", required: true, options: ["Yes — I have a live website", "In progress / coming soon", "No — I don't have one yet"] },
      { id: "q10_website_url", type: "url", required: false, conditionalOn: { field: "q9_has_website", value: "Yes — I have a live website" } },
      { id: "q11_social_platforms", type: "multi_select", required: false, options: ["LinkedIn", "Instagram", "TikTok", "Facebook Page", "X (Twitter)", "WhatsApp Business", "Pinterest", "None yet"] },
      { id: "q12_social_links", type: "long_text", required: false, conditionalOn: { field: "q11_social_platforms", value: "None yet", notEqual: true } },
      { id: "business_identity_notes", type: "long_text", required: false },
    ],
  },
  {
    id: "services",
    ...
    fields: [
      ...
      { id: "q14_flagship_service", type: "short_text", required: true },
      { id: "q15_services", type: "repeating_section", required: true, isRepeating: true, subFields: [
        { id: "service_name", type: "short_text", required: true },
        { id: "service_includes", type: "long_text", required: true },
        { id: "service_excludes", type: "long_text", required: true },
        { id: "service_client_provides", type: "long_text", required: true },
        { id: "service_timeline", type: "short_text", required: true },
        { id: "service_outcome", type: "long_text", required: true },
        { id: "service_starting_price", type: "short_text", required: false },
      ]},
      { id: "q16_uses_subcontractors", type: "single_choice", required: true, options: ["Yes", "No"] },
      { id: "q17_inform_subcontractors", type: "single_choice", required: false, conditionalOn: { field: "q16_uses_subcontractors", value: "Yes" }, options: ["Yes", "No"] },
      { id: "q18_sends_proposal", type: "single_choice", required: true, options: ["Yes — I always send a proposal first", "Sometimes — depends on the project", "No — we agree verbally and get started"] },
      { id: "services_notes", type: "long_text", required: false },
    ],
  },
  {
    id: "clients",
    ...
    fields: [
      { id: "q19_client_type", type: "single_choice", required: true, options: ["Mainly individuals / consumers", "Mainly businesses", "Both equally"] },
      { id: "q20_ideal_client", type: "long_text", required: true },
      { id: "q21_client_industries", type: "long_text", required: false },
      { id: "q22_client_issues", type: "multi_select", required: true, options: ["Client refused to pay", "Client disappeared / went silent after work was delivered", "Scope creep — client asked for far more than agreed", "Refund dispute", "Chargeback through PayPal or card", "Client claimed ownership of work before paying in full", "Missed deadlines caused by the client, not me", "GDPR or data complaint", "Harassment or abusive behaviour", "Threats of legal action", "None of the above"] },
      { id: "q23_dispute_details", type: "long_text", required: false, conditionalOn: { field: "q22_client_issues", value: "None of the above", notEqual: true } },
      { id: "q24_client_concerns", type: "long_text", required: false },
      { id: "clients_notes", type: "long_text", required: false },
    ],
  },
  {
    id: "pricing",
    ...
    fields: [
      { id: "q25_pricing_model", type: "multi_select", required: true, options: ["Fixed project fee", "Hourly rate", "Monthly retainer", "Day rate", "Milestone / stage payments", "Subscription", "Other"] },
      { id: "q26_payment_terms", type: "single_choice", required: true, options: ["100% payment required upfront before work begins", "50% upfront / 50% on completion", "Invoice on completion — due within 7 days", "Invoice on completion — due within 14 days", "Invoice on completion — due within 30 days", "I use milestone payments — invoice at agreed stages", "Custom arrangement"] },
      { id: "q27_payment_detail", type: "long_text", required: false, conditionalOn: { field: "q26_payment_terms", value: ["I use milestone payments — invoice at agreed stages", "Custom arrangement"] } },
      { id: "q28_requires_deposit", type: "single_choice", required: true, options: ["Yes — always", "Yes — for larger projects", "No"] },
      { id: "q29_deposit_detail", type: "short_text", required: false, conditionalOn: { field: "q28_requires_deposit", value: ["Yes — always", "Yes — for larger projects"] } },
      { id: "q30_payment_methods", type: "multi_select", required: true, options: ["Bank transfer (BACS)", "PayPal", "Stripe", "GoCardless", "Wise", "Cash", "Card reader", "Other"] },
      { id: "q31_refund_policy", type: "single_choice", required: true, options: ["No refunds — once work has begun, fees are non-refundable", "Partial refund — proportional to work not yet completed", "Full refund if cancelled within [X] days before work starts only", "Case by case", "I don't currently have a clear policy"] },
      { id: "q32_refund_detail", type: "long_text", required: false, conditionalOn: { field: "q31_refund_policy", value: "No refunds — once work has begun, fees are non-refundable", notEqual: true } },
      { id: "q33_late_payment_interest", type: "single_choice", required: true, options: ["Yes", "No"] },
      { id: "q34_vat_registered", type: "single_choice", required: true, options: ["Yes", "No"] },
      { id: "q35_vat_number", type: "short_text", required: false, conditionalOn: { field: "q34_vat_registered", value: "Yes" } },
      { id: "pricing_notes", type: "long_text", required: false },
    ],
  },
  {
    id: "gdpr",
    ...
    fields: [
      { id: "q36_data_collected", type: "multi_select", required: true, options: ["Full names", "Email addresses", "Phone numbers", "Home or business addresses", "Financial / billing details", "Bank account information", "Copies of ID documents", "Project files and creative work", "Health or medical information", "Information about their employees or staff", "Other"] },
      { id: "q37_data_collection_method", type: "multi_select", required: true, options: ["Email correspondence", "Phone or video calls", "Written contracts or agreements", "Online forms or questionnaires", "Social media messages", "In-person meetings", "Payment processors (e.g. Stripe, PayPal)", "Third-party booking or scheduling tools", "Other"] },
      { id: "q38_data_purpose", type: "long_text", required: true },
      { id: "q39_data_storage", type: "multi_select", required: true, options: ["Google Drive", "Dropbox", "OneDrive", "My local computer / hard drive", "Notion", "Accounting software (e.g. QuickBooks, Xero, FreeAgent)", "CRM software (e.g. Dubsado, HoneyBook)", "Paper records / physical files", "Other"] },
      { id: "q40_data_retention", type: "single_choice", required: true, options: ["1 year", "2 years", "3 years", "6 years (recommended — aligns with HMRC)", "I delete records as soon as the project ends", "I'm not sure / I don't have a policy yet"] },
      { id: "q41_uses_third_party_tools", type: "single_choice", required: true, options: ["Yes", "No"] },
      { id: "q42_third_party_tools", type: "long_text", required: false, conditionalOn: { field: "q41_uses_third_party_tools", value: "Yes" } },
      { id: "q43_shares_data", type: "single_choice", required: true, options: ["Yes", "No", "Sometimes"] },
      { id: "q44_data_sharing_detail", type: "long_text", required: false, conditionalOn: { field: "q43_shares_data", value: ["Yes", "Sometimes"] } },
      { id: "q45_sends_marketing", type: "single_choice", required: true, options: ["Yes", "No"] },
      { id: "q46_marketing_platform", type: "short_text", required: false, conditionalOn: { field: "q45_sends_marketing", value: "Yes" } },
      { id: "q47_uses_cookies", type: "single_choice", required: false, conditionalOn: { field: "q9_has_website", value: "Yes — I have a live website" }, options: ["Yes", "No", "I'm not sure"] },
      { id: "q48_tracking_tools", type: "multi_select", required: false, conditionalOn: { field: "q47_uses_cookies", value: "Yes" }, options: ["Google Analytics", "Meta (Facebook) Pixel", "TikTok Pixel", "Hotjar or Microsoft Clarity", "Cookie consent banner tool", "Other"] },
      { id: "gdpr_notes", type: "long_text", required: false },
    ],
  },
  {
    id: "legal",
    ...
    fields: [
      { id: "q49_regulated_services", type: "single_choice", required: true, options: ["Yes", "No"] },
      { id: "q50_regulatory_detail", type: "long_text", required: false, conditionalOn: { field: "q49_regulated_services", value: "Yes" } },
      { id: "q51_indemnity_insurance", type: "single_choice", required: true, options: ["Yes", "No", "Not yet"] },
      { id: "q52_certifications", type: "long_text", required: false },
      { id: "q53_specific_clauses", type: "long_text", required: false },
      { id: "q54_exclusions", type: "long_text", required: false },
      { id: "legal_notes", type: "long_text", required: false },
    ],
  },
  {
    id: "brand",
    ...
    fields: [
      { id: "q55_first_name", type: "short_text", required: true },
      { id: "q56_business_story", type: "long_text", required: true },
      { id: "q57_experience", type: "long_text", required: true },
      { id: "q58_achievements", type: "long_text", required: false },
      { id: "q59_client_compliments", type: "long_text", required: false },
      { id: "q60_12_month_goal", type: "long_text", required: true },
      { id: "q61_differentiator", type: "long_text", required: true },
      { id: "q62_tone_of_voice", type: "multi_select", required: true, maxSelections: 3, options: ["Warm and friendly", "Professional and formal", "Direct and no-nonsense", "Conversational and approachable", "Calm and reassuring", "Bold and confident", "Luxury and refined", "Creative and energetic"] },
      { id: "q63_avoid_words", type: "long_text", required: false },
      { id: "q64_brand_identity", type: "single_choice", required: true, options: ["My personal name is the brand — I want documents to feel personal", "The business name is the brand — keep it professional and company-facing", "A mix of both"] },
      { id: "q65_has_logo", type: "single_choice", required: true, options: ["Yes", "No"] },
      { id: "q66_logo_upload", type: "file_upload", required: false, conditionalOn: { field: "q65_has_logo", value: "Yes" } },
      { id: "q67_brand_colours", type: "short_text", required: false },
      { id: "q68_visual_style", type: "single_choice", required: true, options: ["Clean and modern / minimal", "Corporate and formal", "Warm and friendly", "Premium and luxury", "Simple — I just want it to work"] },
      { id: "brand_notes", type: "long_text", required: false },
    ],
  },
  {
    id: "invoice",
    ...
    fields: [
      ...
      { id: "invoice_notes", type: "long_text", required: false },
    ],
  },
  {
    id: "linkedin",
    ...
    fields: [
      ...
      { id: "linkedin_notes", type: "long_text", required: false },
    ],
  },
  {
    id: "final",
    ...
    fields: [
      { id: "q76_existing_docs_upload", type: "file_upload", required: false },
      { id: "q77_writing_samples_upload", type: "file_upload", required: false },
  ...
  },
  {
    ...
    fields: [
      ...
      { id: "wc_testimonials_featured", type: "long_text", required: false },
      { id: "website_copy_notes", type: "long_text", required: false },
    ],
  },
  {
    id: "social_media",
    ...
    fields: [
      ...
      { id: "social_media_notes", type: "long_text", required: false },
    ],
  },
  {
    ...
    fields: [
      ...
      { id: "client_onboarding_notes", type: "long_text", required: false },
    ],
  },
  {
    ...
    fields: [
      ...
      { id: "payment_protection_notes", type: "long_text", required: false },
    ],
  },
  {
    ...
    fields: [
      ...
      { id: "copyright_licensing_notes", type: "long_text", required: false },
    ],
  },
  {
    id: "gdpr_deep",
    ...
    fields: [
      ...
      { id: "gdpr_deep_notes", type: "long_text", required: false },
    ],
  },
  {
    id: "industry_coach",
    ...
    fields: [
      ...
      { id: "industry_coach_notes", type: "long_text", required: false },
    ],
  },
  {
    ...
    fields: [
      ...
      { id: "industry_photographer_notes", type: "long_text", required: false },
    ],
  },
  {
    ...
    fields: [
      ...
      { id: "industry_consultant_notes", type: "long_text", required: false },
    ],
  },
  {
    ...
    fields: [
      ...
      { id: "industry_contractor_notes", type: "long_text", required: false },
    ],
  },
];
